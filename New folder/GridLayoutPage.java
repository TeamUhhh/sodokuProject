...
public class GridLayoutPage extends JFrame implements ActionListener{
	...
	public GridLayoutPage(final int x, final int y, String level, Boolean checkDemo, Boolean checkColor, Color setColor, Boolean checkNumberColor, Color numberColor) {
		...
		JButton defaultButton1 = new JButton("Set Back to Default0");
		...
		JButton defaultButton = new JButton("Set Back to Default1");
			...
			input[i].addKeyListener(new KeyListener() 
			{
				...
				public void keyPressed(KeyEvent e)
				{
					if (e.getKeyCode() == KeyEvent.VK_RIGHT) {
						if (e.getModifiers() > 0) {
							input[counter].transferFocusBackward();
						} else {
							input[counter].transferFocus();
						}
						e.consume();
					}
					...
					else if(e.getKeyCode()==KeyEvent.VK_DOWN)
					{
						...
						input[counter+8].transferFocus();
						e.consume();
					}
					else if(e.getKeyCode()==KeyEvent.VK_UP)
					{

						input[counter-10].transferFocus();
						e.consume();
					}
				}
	...
	public void actionPerformed(ActionEvent e) {
		...
		// will get rid of current window and go back to home
			...
			dispose();
			StartMenu newStart = new StartMenu(true, false, false);
